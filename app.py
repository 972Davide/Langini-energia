...
def carica_dati():
    try:
        ...
        # Rinominiamo la prima colonna di entrambi in 'Tempo' per il merge
        ...
        # Pulizia colonne numeriche - usa i nomi ESATTI del tuo file
        cols_to_fix = ['Vento (m/s)', 'Watt', 'Temperatura', 'Pressione Mare', 'Umidità']
...
if df is not None and not df.empty:
    ...
    # METRICHE (Usiamo i nomi corretti: 'Temperatura' e 'Umidità' dal file Meteo)
    ...
    with col2:
        ...
        # Corretto riferimento a 'Temperatura' invece di 'Temp. Est'
    ...
    st.warning("Dati non trovati. Verifica che le colonne si chiamino esattamente: 'Temperatura', 'Umidità', 'Vento (m/s)', 'Watt'.")
    time.sleep(10)
    st.rerun()
